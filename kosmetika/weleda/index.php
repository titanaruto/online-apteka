...
$APPLICATION->SetTitle("Weleda - натуральная швейцарская косметика"); 
?>
		...
		<div class="vertical-flipping-container" href="">
			<div class="vertical-wrap-face">
				<div class="vertical-front vertical-face">
					<img src="img/weleda.jpg" alt="" />
				</div>
				<a target="blank" href="/kosmetika/weleda/jurnal.php" class="vertical-back vertical-face">
					<img src="img/weleda.jpg" alt="" />
					<div class="bg">
