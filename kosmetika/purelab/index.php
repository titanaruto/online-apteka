...
$APPLICATION->SetTitle("PURELAB - швейцарская дермокосметика "); 
?>
		...
		<div class="vertical-flipping-container" href="">
			<div class="vertical-wrap-face">
				<div class="vertical-front vertical-face">
					<img src="img/purelab.jpg" alt="" />
				</div>
				<a target="blank" href="/kosmetika/purelab/jurnal.php" class="vertical-back vertical-face">
					<img src="img/purelab.jpg" alt="" />
					<div class="bg">
