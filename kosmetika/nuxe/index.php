...
$APPLICATION->SetTitle("Nuxe - натуральная французская косметика"); 
?>
		...
		<div class="vertical-flipping-container" href="">
			<div class="vertical-wrap-face">
				<div class="vertical-front vertical-face">
					<img src="img/NUXE.jpg" alt="" />
				</div>
				
				<a target="blank" href="/kosmetika/nuxe/jurnal.php" class="vertical-back vertical-face">
					<img src="img/NUXE.jpg" alt="" />
					<div class="bg">
