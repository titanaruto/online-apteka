...
$APPLICATION->SetTitle("CAUDALIE - французская лечебная косметика"); 
?>
		...
		<div class="vertical-flipping-container" href="">
			<div class="vertical-wrap-face">
				<div class="vertical-front vertical-face">
					<img src="img/caudalie.jpg" alt="" />
				</div>
				
				<a target="blank" href="/kosmetika/caudalie/jurnal.php/" class="vertical-back vertical-face">
					<img src="img/caudalie.jpg" alt="" />
					<div class="bg">
