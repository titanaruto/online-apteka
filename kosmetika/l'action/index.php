...
$APPLICATION->SetTitle("L'Action Paris - французская косметическая марка "); 
?>
		...
		<div class="vertical-flipping-container" href="">
			<div class="vertical-wrap-face">
				<div class="vertical-front vertical-face">
					<img src="img/laction-1.jpg" alt="" />
				</div>
				<a target="blank"  href="/kosmetika/l'action/jurnal.php" class="vertical-back vertical-face">
					<img src="img/laction-1.jpg" alt="" />
					<div class="bg">
