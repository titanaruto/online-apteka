...
<?endif?>
		<div class="bx-authform-formgroup-container">
			<!--input style="float: none; display: block;" type="submit" class="mc-button user" name="Login" value="<?=GetMessage("AUTH_AUTHORIZE")?>" /> -->
			<button style="margin-left: 35px; float: none; display: block;" type="submit" class="mc-button user" name="Login" value=""><i class="fa fa-user" aria-hidden="true"></i><?=GetMessage("AUTH_AUTHORIZE")?></button>
		</div>
	</form>
