...
<div class="bx_item_slider" id="<? echo $arItemIDs['BIG_SLIDER_ID']; ?>">
    ...
    <span class="bx_bigimages_aligner">
        <?php if($file['height'] == 0){?>
            <img id="<? echo $arItemIDs['PICT']; ?>" src="/bitrix/templates/eshop_adapt_MC/components/bitrix/catalog/.default/bitrix/catalog.element/price/images/no_photo.png" alt="<? echo $strAlt; ?>" title="<? echo $strTitle; ?>">
        <?php } else {?>
