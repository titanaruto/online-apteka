...
<?
	...
	if($minPrice['VALUE'] > 0 ) {
		...
		echo $minPrice['PRINT_DISCOUNT_VALUE'].'</div>';
	...
	?><div class="item_economy_price" 
		...
		style="display: <? echo ($boolDiscountShow ? '' : 'none'); ?>"><? 
...
<?
	...
	if ($showAddBtn)
	{
		...
		<a href="javascript:void(0);" class="bx_big bx_bt_button bx_cart" id="<? echo $arItemIDs['ADD_BASKET_LINK']; ?>"><span></span><? echo $addToBasketBtnMessage; ?></a>
			...
			?>
			<a href="javascript:void(0);" class="bx_big bx_bt_button bx_cart" id="<? echo $arItemIDs['ADD_BASKET_LINK']; ?>"
			  style="background-color: RGB(34,98,160);"><span></span>Под заказ</a>
			<?
		}
	}
?>
		...
		<div class="tab_containers">
			...
			<div class="tab_2_conts">
				...
				*/ ?>
				...
				?>
				<iframe src=<?echo '"/upload/html/'.$arResult['DETAIL_TEXT'].'"';?>" frameborder="0"></iframe>
				<?}?>
			</div>
		</div>
	</div>
