	...
	<div class="tabs_containers">
		<div class="tabs_1_conts clearfix">
			...
			if(true !== empty($VALUES['0'])) {
				...
				$arSelect = array('IBLOCK_ID','ID','NAME','DETAIL_PICTURE','DETAIL_PAGE_URL','ADD_URL_TEMPLATE');
								...
								//<Начало>Выводим link элемента
									...
									if(!empty($arElem['DETAIL_PICTURE'])){
										$file = CFile::ResizeImageGet(
											...
											$img = '<div class="wrapper_img" style="width:253px;height:256px;"><img src="'.$file['src'].'" width="'.$file['width'].'" height="'.$file['height'].'" /></div>';
											echo $img;
										} else {
											$img = '<div class="wrapper_img" style="width:253px;height:256px;"><img src="/upload/a_obmen/JPG/net_foto.jpg" style="width:253px;height:256px;" /></div>';
											echo $img;
										}
										...
										$arElements[]=$arElem;
										echo '<span class="link_button">'.'Перейти'.'</span>';
