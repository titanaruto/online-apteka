	...
	if (!isset($arItem['OFFERS']) || empty($arItem['OFFERS']))
	{
		...
		<div id="<? echo $arItemIDs['BASKET_ACTIONS']; ?>" class="bx_catalog_item_controls_blocktwo">
			...
			?>
				...
				// если ноль то под заказ
				?><a id="<? echo $arItemIDs['BUY_LINK']; ?>" class="bx_bt_button bx_medium" href="javascript:void(0)" 
				rel="nofollow" style="background-color: RGB(34,98,160);">Под заказ</a><?
			}
				?>
		</div>
			<?
