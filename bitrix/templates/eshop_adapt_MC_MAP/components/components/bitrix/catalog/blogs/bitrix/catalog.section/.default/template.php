...
$_SESSION['RELATIVE_BLOG']['DETAIL']='N';
$_SESSION['RELATIVE_BLOG']['SECTION']='Y';
$_SESSION['RELATIVE_BLOG']['DEPTH_LEVEL']=$arResult['DEPTH_LEVEL'];
?>
<?
...
<div class="wrapper-centered-catalog">
