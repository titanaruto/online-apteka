...
<?/*<div class="bx_ordercart_order_pay">Введите номер дисконтной карты без впередиидущих нулей: <input
		name="DKCARD" type="text" value="" id="dkstr" onblur="checkDK(this);"></div>*/?>
