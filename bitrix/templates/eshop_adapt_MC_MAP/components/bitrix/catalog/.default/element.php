       ...
       <div class="item active">
          <div class="row">
              <div class="col-sm-12">
              	 <? 
					global $aaaFilter;
					$aaaFilter = Array('PROPERTY' => array('SPECIALOFFER' => 3) );
					...
					"FILTER_NAME" => "aaaFilter",	// Имя массива со значениями фильтра для фильтрации элементов
					...
					"LABEL_PROP" => "SPECIALOFFER",	// Свойство меток товара
					"OFFER_ADD_PICT_PROP" => "-",
					...
					"PRODUCT_QUANTITY_VARIABLE" => "count",	// Название переменной, в которой передается количество товара
