			...
			<?if($_POST["is_ajax_post"] != "Y")
			{
				?>
					...
					<div class="bx_ordercart_order_pay_center">
						<button href="javascript:void();" onclick="submitForm('Y'); return false;" id="ORDER_CONFIRM_BUTTON" class="checkout mc-button"><?=GetMessage("SOA_TEMPL_BUTTON")?></button>
					</div>
					<?if(!isset($_GET['ORDER_ID'])){
						echo '<a href="/" style="display: inline-block; float: none;" class="mc-button">Продолжить покупки</a>';
					}
					?>
				</form>
				<?
