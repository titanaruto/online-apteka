...
<?
unset($arResult['PAY_SYSTEM'][8]);
unset($arResult['PAY_SYSTEM'][9]);
unset($arResult['PAY_SYSTEM'][10]);
unset($arResult['PAY_SYSTEM'][11]);
					...
					<div class="bx_block w100 vertical">
						<div class="bx_element">
							...
							<input type="radio"
								...
								/>
							<label class="ID_PAY_SYSTEM_ID_<?=$arPaySystem["ID"]?>" for="ID_PAY_SYSTEM_ID_<?=$arPaySystem["ID"]?>" onclick="BX('ID_PAY_SYSTEM_ID_<?=$arPaySystem["ID"]?>').checked=true;changePaySystem();">
								<?
