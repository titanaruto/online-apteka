...
$MESS['SOA_TEMPL_PAY_SYSTEM'] = "Выберите способ оплаты"; 
...
$MESS['SOA_TEMPL_ORDER_SUC_TEXT'] = "Для подтверждения заказа мы свяжемся с Вами в течение <b>30 мин.</b> <br />
При подтверждении заказа по номеру горячей линии Вы можете выбрать адрес доставки товара в аптеку и способ оплаты. <br />
1. В случае безналичного расчета (оплата услуги бронирования заказа картами Visa/MasterСard) после подтверждения Вашего заказа перейдите в Ваш <a href=\"/personal/order/\" style=\"display:inline;\">персональный раздел</a> 
сайта (Мои заказы) либо по ссылке, полученной в оповещении об оплате заказа на указанный Вами e-mail. <br />
...
$MESS['SOA_TEMPL_RELATED_PROPS'] = "Свойства, связаные с оплатой и доставкой";
...
$MESS['SOA_TIME_DELIVERY'] = "Укажите время доставки:";
$MESS['SOA_DATE_DELIVERY'] = "Укажите дату доставки:";
$MESS['Courier address'] = "Укажите адрес доставки:";
$MESS['SOA_ADDRESS_DELIVERY'] = "Выберите способ доставки:";
$MESS['SOA_DELIVERY_VARIANTS'] = "Способы доставки...";
$MESS['SOA_CHANGE_DELIVERY_VARIANT'] = "Выбрать способ доставки:";
$MESS['Enter a location'] = "Введите адрес";
$MESS['SOA_TEMPL_GET_PRODUCT_CITY'] = "Выберите город получения товара:";
?>