...
<div class="bx_mfeedback bx_<?=$arResult["THEME"]?>">
	...
	<form action="<?=POST_FORM_ACTION_URI?>" method="POST">
		...
		<input required="required" type="text" name="user_name" value="<?=$arResult["AUTHOR_NAME"]?>"/><br/>
		...
		<input required="required" type="email" name="user_email" value="<?=$arResult["AUTHOR_EMAIL"]?>"/><br/>
		...
		<textarea required="required" name="MESSAGE" rows="5" cols="40"><?=$arResult["MESSAGE"]?></textarea><br/>
