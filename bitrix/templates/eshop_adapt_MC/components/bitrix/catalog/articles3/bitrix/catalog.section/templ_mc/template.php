...
$this->setFrameMode(true);?>
	<?if (!empty($arResult['ITEMS'])){
		...
		<div class="bx_catalog_list_home col<?
			echo $arParams['LINE_ELEMENT_COUNT']; ?> <?
			echo $templateData['TEMPLATE_CLASS']; ?>"><?
			...
			foreach ($arResult['ITEMS'] as $key => $arItem){
				...
				?>
				<div class="clearfix <?echo ($arItem['SECOND_PICT'] ? 'bx_catalog_item double' : 'bx_catalog_item'); ?>">

					<div class="bx_catalog_item_container" id="<? echo $strMainID; ?>">
					
						<a id="<? echo $arItemIDs['PICT']; ?>" 
							href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" 
							class="bx_catalog_item_images-col" 
							...
							><?
									...
									<a id="<? echo $arItemIDs['SECOND_PICT']; ?>" 
										...
										<?if ('Y' == $arParams['SHOW_DISCOUNT_PERCENT']){?>
											<div id="<? echo $arItemIDs['SECOND_DSC_PERC']; ?>" 
												...
												style="display:<?echo (0 < $minPrice['DISCOUNT_DIFF_PERCENT'] ? '' : 'none'); ?>;">-<?				echo $minPrice['DISCOUNT_DIFF_PERCENT']; ?>%</div>
										<?}
										if ($arItem['LABEL']){?>
								...
								?><div class="bx_catalog_item_title">
									<a href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" 
										title="<? echo $productTitle; ?>"><? echo $productTitle; ?>
									</a>
									<a class="bx_catalog_item_title-text" href=""><?echo $arResult['PREVIEW_TEXT']?></a>
								</div><!-- end bx_catalog_item_title --><?
		...
		</div> <!--end bx_catalog_list_home col  !!!!!этот сидел за форейчем !!!!-->
