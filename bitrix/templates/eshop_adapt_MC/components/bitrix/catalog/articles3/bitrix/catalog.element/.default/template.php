...
?>
		...
		?>
			<span class="description_Element">
...
<?
	...
	{
?>
			<a href="javascript:void(0);" class="bx_big bx_bt_button bx_cart mc-button" id="<? echo $arItemIDs['BUY_LINK']; ?>"><span></span><? echo $buyBtnMessage; ?></a>
<?
	}
	if ($showAddBtn)
	{
?>
			<a href="javascript:void(0);" class="bx_big bx_bt_button bx_cart mc-button" id="<? echo $arItemIDs['ADD_BASKET_LINK']; ?>"><span></span><? echo $addToBasketBtnMessage; ?></a>
<?
	}
?>
		</span>
...
<div class="tab-section-container">
	<div class="Tabs_Detail_Page">
		...
		<label for="tab_2">Инструкция</label>
		<div class="tab_containers">
			...
			<div class="tab_2_conts">
				...
				*/ ?>
				...
				<iframe charset="utf-8" src="/upload/050306765_3C14.htm" frameborder="0"></iframe>
			</div>
		</div>
	</div>
<?
