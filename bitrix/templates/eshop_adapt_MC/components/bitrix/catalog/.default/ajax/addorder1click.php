...
$_POST["phone"] = $arAnswer["phone"][0]["USER_TEXT"];
$_POST["adres"] = $arAnswer["address"][0]["USER_TEXT"];
$_POST["QUANTITY"] = $arAnswer["reserve_qty"][0]["USER_TEXT"];
$_POST["product_id"] = $arAnswer["productId"][0]["USER_TEXT"];
$_POST["id_local"] = $arAnswer["pharm_id"][0]["USER_TEXT"];
