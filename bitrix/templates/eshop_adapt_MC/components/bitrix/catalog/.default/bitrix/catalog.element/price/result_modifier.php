<?
if (isset($arResult['PRICES']['BASE']['VALUE']) && $arResult['PRICES']['BASE']['VALUE'] == 0) {
...
$product_propeties = CCatalogProduct::GetByIDEx($arResult["ID"])["PROPERTIES"];
$arResult["PHARM_LEFTOVERS"] = $product_propeties["PHARM_LEFTOVERS"]["VALUE"];
$arResult["LAST_AVAILABILITY"] = $product_propeties["LAST_AVAILABILITY"]["VALUE"];
unset($arResult["IPROPERTY_VALUES"]["ELEMENT_META_DESCRIPTION"]);
