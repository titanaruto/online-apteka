								...
								//<Начало>Выводим link элемента
									...
									if(!empty($arElem['DETAIL_PICTURE'])){
										$file = CFile::ResizeImageGet(
											...
											$img = '<div class="wrapper_img" style="width:253px;height:256px;"><img src="/upload/a_obmen/JPG/no_photo.png" style="width:253px;height:256px;" /></div>';
											echo $img;
										}
										...
										$arElements[]=$arElem;
										echo '<span class="link_button">'.'Купить'.'</span>';
