...
<div class="bx_profile bx_<?=$arResult["THEME"]?>">
	<form method="post" name="form1" action="<?=$arResult["FORM_TARGET"]?>?" enctype="multipart/form-data">
		...
		<div>
			...
			<input type="text" name="NAME" maxlength="50" placeholder="<?=$arResult["arUser"]["NAME"]?>" value="<?/*=$arResult["arUser"]["NAME"]*/?>" />
		</div>	
		
		<div>
			<span><?=GetMessage('LAST_NAME')?></span>
			<input type="text" name="LAST_NAME" maxlength="50" placeholder="<?=$arResult["arUser"]["LAST_NAME"]?>" value="<?/*=$arResult["arUser"]["LAST_NAME"]*/?>" />
		</div>
		
		<div>
			<span><?=GetMessage('SECOND_NAME')?></span>
			<input type="text" name="SECOND_NAME" maxlength="50"  placeholder="<?=$arResult["arUser"]["SECOND_NAME"]?>" value="<?/*=$arResult["arUser"]["SECOND_NAME"]*/?>" />
		</div>
