...
if (!empty($arResult['ITEMS']))
{
	...
	$strEmptyPreview = $this->GetFolder().'/images/no_photo.webp';
	...
	foreach ($arResult['ITEMS'] as $key => $arItem)	{
        $product_propeties = CCatalogProduct::GetByIDEx($arItem["ID"])["PROPERTIES"];
	    $arItem["PHARM_LEFTOVERS"] = $product_propeties["PHARM_LEFTOVERS"]["VALUE"];
        $arItem["LAST_AVAILABILITY"] = $product_propeties["LAST_AVAILABILITY"]["VALUE"];
...
//pre($ar_res["PROPERTIES"]["PRODUCT_SUPPLIER"]);
//pre($arResult);
?>