...
?>
<div class="voting-form-box own-voting-form">
	<form action="<?=POST_FORM_ACTION_URI?>" method="post" class="vote-form">
		...
		<div class="vote-wrapper">
			...
			?>
				<div class="vote-item-title vote-item-question owl-item-quest"><?=$arQuestion["QUESTION"]?><?if($arQuestion["REQUIRED"]=="Y"){echo "<span class='starrequired'>*</span>";}?></div>
						<div class="vote-clear-float"></div>
					</div>
					
					<ol class="vote-items-list vote-answers-list vote-list-variant">
			<?
					$iCountAnswers = 0;
			...
			<div class="vote-form-box-buttons vote-vote-footer">
				<span class="vote-form-box-button vote-form-box-button-first mc-button"><input type="submit" name="vote" value="<?=GetMessage("VOTE_SUBMIT_BUTTON")?>" /></span>
			<?/*?>	<span class="vote-form-box-button vote-form-box-button-last"><input type="reset" value="<?=GetMessage("VOTE_RESET")?>" /></span><?*/?>
				<span class="vote-form-box-button vote-form-box-button-last mc-button">
					<a name="show_result" <?
...
<!-- Dropdown vote block -->
<script>
	  var menuElem = document.getElementById('vote-question');
	  var titleElem = menuElem.nextElementSibling;
