						...
						foreach ($arResult["GRID"]["HEADERS"] as $id => $arHeader):
									...
									<div class="centered">
										<table cellspacing="0" cellpadding="0" class="counter">
											<tr>
												...
												{
													?>
														<td class="quantity"><?=$arItem["MEASURE_TEXT"]?></td>
													<?
												}
												?>
											</tr>
							...
							?>
								<td class="custom">
									...
									if ($arHeader["id"] == "SUM"):
									?>
										<div class="price_summ" style="
											font: 20px 'Roboto Condensed', sans-serif;
    										color: #02578e;" id="sum_<?=$arItem["ID"]?>">
										<?
											endif;
...
?>
			...
			<table class="bx_ordercart_order_sum">
				...
				<?endif;?>
					...
					<tr>
						...
						<td class="fwb2" id="allSum_FORMATED"><?=str_replace(" ", "&nbsp;", $arResult["allSum_FORMATED"])?></td>
					</tr>
					<tr>
		...
		<div class="bx_ordercart_order_pay_center">
			...
			<a href="javascript:void(0)" onclick="checkOut();" class="qwerty checkout"><?=GetMessage("SALE_ORDER")?></a>
		</div>
	</div>
</div>
<?
