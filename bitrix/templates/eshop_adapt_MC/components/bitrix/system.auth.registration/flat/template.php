...
<div class="w"></div>
	...
	<div class="bx-authform-formgroup-container">
		...
		<?/* pre ($USER[PERSONAL_BIRTHDAY])
		<div class="bx-authform-label-container"><?=GetMessage("AUTH_SECOND_NAME")?></div>
			<div class="bx-authform-input-container">
				<input type="text" name="USER_LAST_NAME" maxlength="255" value="<?=$arResult["USER_SECOND_NAME"]?>" />
			</div>
		</div>
		*/?>
		<div class="bx-authform-formgroup-container">
...
<?endif?>
		<div class="bx-authform-formgroup-container">
			<!--input type="submit" class="mc-button badge" name="Register" value="<?=GetMessage("AUTH_REGISTER")?>" /-->
			<button style="float: none; display: block; margin-right: 35px;" type="submit" class="mc-button user" name="Register" value=""><?=GetMessage("AUTH_REGISTER")?><i class="fa fa-user" aria-hidden="true"></i></button>
		</div>
