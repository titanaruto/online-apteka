...
<div class="bx_catalog_list_home col<? echo $arParams['LINE_ELEMENT_COUNT']; ?> <? echo $templateData['TEMPLATE_CLASS']; ?>" itemscope itemtype="http://schema.org/Product">
	<?
foreach ($arResult['ITEMS'] as $key => $arItem) {
	...
	?>
	<div class="<? echo ($arItem['SECOND_PICT'] ? 'bx_catalog_item double' : 'bx_catalog_item'); ?>" itemprop='description'>
		<div data-log="<?php print_r([$arItem["PHARM_LEFTOVERS"], $arItem["ID"], $arItem["XML_ID"], $arItem["LAST_AVAILABILITY"], $buy_status, $product_price]) ?>" class="bx_catalog_item_container" id="<? echo $strMainID; ?>">
		<a
	...
	if (!isset($arItem['OFFERS']) || empty($arItem['OFFERS']))
	{
		...
		<div id="<? echo $arItemIDs['BASKET_ACTIONS']; ?>" class="bx_catalog_item_controls_blocktwo">
            <?php
            if ($buy_status == 1) {?>
			<button id="<? echo $arItemIDs['BUY_LINK']; ?>" class="mc-button" rel="nofollow"><?
