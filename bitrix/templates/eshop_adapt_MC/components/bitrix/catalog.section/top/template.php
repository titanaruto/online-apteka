...
foreach ($arResult['ITEMS'] as $key => $arItem) {
    ...
    $buy_status = Tools::isVisibleButtonForOrder($arItem["PHARM_LEFTOVERS"], $arItem["LAST_AVAILABILITY"], $product_price);
    $CPrice = new CPrice;
    $res = $CPrice->GetList(
        array(),
        ...
        <div data-log="<?php print_r([$arItem["PHARM_LEFTOVERS"], $arItem["ID"], $arItem["XML_ID"], $arItem["LAST_AVAILABILITY"], $buy_status, $product_price]) ?>" class="bx_catalog_item_container" id="<? echo $strMainID; ?>">
            <a
                ...
                if ('Y' == $arParams['SHOW_DISCOUNT_PERCENT']) {
                    ...
                    <div id="<? echo $arItemIDs['DSC_PERC']; ?>"
                         class="bx_stick_disc right bottom" <? echo(0 < $minPrice['DISCOUNT_DIFF_PERCENT'] ? '' : 'style="display:none;"'); ?>>
                ...
                //if ($arItem['LABEL']){
                ?>
                <div id="<? echo $arItemIDs['STICKER_ID']; ?>" class="bx_stick average left top"
                     title="<? echo 'ТОП ПРОДАЖ'/*$arItem['LABEL_VALUE']*/
                     ; ?>"><? echo 'ТОП ПРОДАЖ'/*$arItem['LABEL_VALUE']*/
                    ; ?></div>
                <?
                //}
                ?>
            ...
            if ($arItem['SECOND_PICT']) {
                ?><a id="<? echo $arItemIDs['SECOND_PICT']; ?>" href="<? echo $arItem['DETAIL_PAGE_URL']; ?>"
                     class="bx_catalog_item_images_double" style="background-image: url('<? echo(
		...
		*/
            ...
            if ('Y' != $arParams['SHOW_DISCOUNT_PERCENT']) {
                ...
                <div class="sails-price">
                    ...
                    <span class="percent zabota"><?= round($arItem['CATALOG_PRICE_1'] * 0.93, 2) . ' грн'; ?><?/*=round($arItem['CATALOG_PRICE_1']*0.9, 2).' грн';*/
                        ?></span>
                </div>
            <?
            } ?>
