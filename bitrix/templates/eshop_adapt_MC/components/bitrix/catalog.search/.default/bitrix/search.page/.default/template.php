...
<?else:?>
	<input type="text" class="bx-form-control" name="q" value="<?=$arResult["REQUEST"]["QUERY"]?>" size="40" />
<?endif;?>
	&nbsp;<button style="float: none; margin-top: 0;" class="mc-button search" type="submit" value="" ><i class="fa fa-search"></i><?=GetMessage("SEARCH_GO")?></button>
