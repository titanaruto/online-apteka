...
//оставляем пакетик
array_splice($arResult["DEFAULT_SET_IDS"],1);
foreach ($arResult["SET_ITEMS"]["DEFAULT"] as $ke => $val){
    $arResult["DEFAULT_SET_IDS"][]=$val['ID'];
}
$arResult["SET_ITEMS"]["OTHER"] = array();
$arResult["SET_ITEMS"]["PRICE"] = 0.25;
	...
	<div class="row">
			...
			<div class="bx-added-item-table-container">
				<table class="bx-added-item-table">
					...
					<?foreach($arResult["SET_ITEMS"]["DEFAULT"] as $key => $arItem):?>
                        <?$arResult["SET_ITEMS"]["PRICE"]+= $arItem["PRICE_VALUE"] ?>
						<tr
							data-id="<?=$arItem["ID"]?>"
		...
		<div class="col-sm-3">
			<div class="bx-constructor-container-result">
				<span class="bx-item-set-current-price" data-role="set-price"><?=$arResult["SET_ITEMS"]["PRICE"].' грн.'?></span>
