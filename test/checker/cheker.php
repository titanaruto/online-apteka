...
function mailer($type, $count){
    switch ($type) {
        case '0':
            $to = 'savchenko.maksim@med-service.com.ua, kostenko.artem@med-service.com.ua,
                    bitsoev.taras@med-service.com.ua, barabash.ivan@med-service.com.ua, bilitskaya.marina@med-service.com.ua';
            $subject  = 'Внимание !!! Слишком много заказов в обмене для 1С - '.$count;
            break;
        case '1':
            $to = 'bitsoev.taras@med-service.com.ua, barabash.ivan@med-service.com.ua, bilitskaya.marina@med-service.com.ua';
